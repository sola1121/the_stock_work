...
sql_ware3 = 'select enter_date from stocks where stock_id =:1 '
...
sql_ord1 = 'select rent_id from rents where rent_id =:1 '
sql_ord2 = 'select rent_date from rents where rent_date =:1 '
sql_ord3 = 'select rent_price from rents where rent_id =:1 '
sql_ord4 = 'select user_id from rents where rent_id =:1 '
sql_ord5 = 'select stock_id from rents where rent_id =:1 '
sql_ord6 = 'select deliveryman from rents where rent_id =:1 '
sql_ord7 = 'select status from rents where rent_id =:1 '
sql_ord8 = 'select back_date from rents where rent_id =:1 '

sql_ord_search = 'select * from rents ' \
                 'where rent_id like :rent_id ' \
                 'and rent_date like :rent_date ' \
                 'and rent_price like :rent_price ' \
                 'and user_id like :user_id ' \
                 'and stock_id like :stock_id ' \
                 'and deliveryman like :delman ' \
                 'and status like :status ' \

sql_ord_stock = "update stocks set quantity=quantity+1 where stock_id =:1 "
sql_ord_update1 = "update rents set status='1', back_date = sysdate, " \
                  "deliveryman =:delman, rent_price =:rent_price where rent_id =:rent_id "
sql_ord_update2 = "update rents set status='1', back_date =:back_date, " \
                  "deliveryman =:delman, rent_price =:rent_price where rent_id =:rent_id "
...
sql_cus4 = 'select balance from users where user_id =:1'
...
sql_update_cus = "update users set user_name=:user_name, gender=:sex_, " \
                 "balance=:balance, passwd=:user_pwd, address=:user_address where user_id =:user_id"
